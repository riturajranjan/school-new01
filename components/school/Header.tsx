...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40" data-header>
      ...
      >
        <div className="mx-auto flex w-full max-w-normal items-center justify-end gap-6 px-8 py-2 text-[12px] font-semibold text-white/85">
      ...
      >
        <nav
          aria-label="Primary"
          className={cn(
            "mx-auto flex w-full max-w-normal items-center justify-between gap-4 px-5 transition-all duration-300 sm:px-6 lg:px-8",
              ...
              return (
                <li key={item.sectionId}>
                  <a
                    ...
                    className={cn(
                      "relative rounded-full px-3 py-2 text-[13px] font-bold transition-colors",
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        "absolute inset-x-3 -bottom-0.5 h-0.5 rounded-full bg-indigo transition-transform duration-300",
